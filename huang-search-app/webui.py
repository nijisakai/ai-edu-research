...
# Work around Gradio schema parsing bugs triggered by bool JSON schema nodes.
if hasattr(gr_client_utils, "_json_schema_to_python_type"):
...
existing_head = getattr(demo, "head", "") or ""
demo.head = existing_head + f"<style>{css}</style>" + javascript
# --- Launch the App ---
